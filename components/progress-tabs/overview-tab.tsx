...
import { CompetencyBrainMap } from "@/components/intelligence/CompetencyBrainMap";
...
export function OverviewTab() {
  ...
  return (
    <div className="flex h-full min-h-0 flex-col gap-4 p-4">
      ...
      {/* Competency Network Graph */}
      <section className="grid gap-4">
        <Card className="col-span-1 border-slate-200">
          <CardHeader>
            <CardTitle>Competency Brain Map</CardTitle>
            <CardDescription>Visual breakdown of your verified competencies and pre-requisites.</CardDescription>
          </CardHeader>
          <CardContent>
            <CompetencyBrainMap />
          </CardContent>
