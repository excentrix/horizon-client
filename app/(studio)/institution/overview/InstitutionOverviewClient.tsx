    ...
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row justify-between md:items-center gap-4">
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            Real-time cohort performance, engagement trends, and risk management.
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <Card className="bg-muted/10">
          <CardHeader className="pb-2">
            <CardDescription className="text-xs uppercase tracking-wider">Total Students</CardDescription>
            <CardTitle className="text-3xl font-bold">{studentCount}</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="text-xs text-muted-foreground flex items-center gap-1">
              <Users className="h-3 w-3" /> across all active tracks
            </div>
          </CardContent>
        </Card>
        <Card className="bg-muted/10">
          <CardHeader className="pb-2">
            <CardDescription className="text-xs uppercase tracking-wider">Avg Progress</CardDescription>
            <CardTitle className="text-3xl font-bold">{avgProgress}%</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="text-xs text-muted-foreground flex items-center gap-1">
              <Activity className="h-3 w-3" /> cohort-wide mean
            </div>
          </CardContent>
        </Card>
        <Card className="bg-muted/10">
          <CardHeader className="pb-2">
            ...
            <CardTitle className="text-3xl font-bold text-red-500">{atRiskCount}</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="text-xs text-red-400 font-medium flex items-center gap-1">
              <AlertTriangle className="h-3 w-3" /> requires intervention
            </div>
          </CardContent>
        </Card>
        <Card className="bg-muted/10">
          <CardHeader className="pb-2">
            <CardDescription className="text-xs uppercase tracking-wider">Engagement Delta</CardDescription>
            <CardTitle className={cn("text-3xl font-bold", engagementDelta < 0 ? "text-red-500" : "text-emerald-500")}>
              {engagementDelta > 0 ? `+${engagementDelta}` : engagementDelta}
            </CardTitle>
          </CardHeader>
          <CardContent>
            <div className="text-xs text-muted-foreground flex items-center gap-1">
              <Zap className="h-3 w-3" /> VS previous 7d
            </div>
          </CardContent>
        </Card>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <Card className="lg:col-span-2">
          <CardHeader>
            ...
            <CardDescription>Number of students by curriculum completion bracket.</CardDescription>
          </CardHeader>
        ...
        <Card>
          <CardHeader>
            <CardTitle className="text-lg">Cohort Health</CardTitle>
            <CardDescription>Overall ratio of an on-track vs at-risk students.</CardDescription>
          </CardHeader>
          <CardContent className="h-[300px] flex flex-col items-center justify-center">
            ...
            <div className="flex gap-4 mt-2">
              {riskDistribution.map((r) => (
                <div key={r.name} className="flex items-center gap-1.5 pt-2">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <Card>
          <CardHeader>
            <CardTitle className="text-lg text-red-500 flex items-center gap-2">
               <AlertTriangle className="h-5 w-5" /> Risk Level Breakdown
            </CardTitle>
            <CardDescription>High-risk students often have multiple overdue tasks or low engagement.</CardDescription>
          </CardHeader>
          <CardContent className="h-[280px]">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={riskLevelMix} layout="vertical">
                <XAxis type="number" hide />
                <YAxis dataKey="level" type="category" fontSize={12} tickLine={false} axisLine={false} />
        ...
        <Card>
          <CardHeader>
            <CardTitle className="text-lg">Inactivity Analysis</CardTitle>
            <CardDescription>How long has it been since students logged in or performed a task?</CardDescription>
          </CardHeader>
          <CardContent className="h-[280px]">
            <ResponsiveContainer width="100%" height="100%">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <Card>
          <CardHeader>
            <CardTitle className="text-lg">Engagement Momentum</CardTitle>
            <CardDescription>Student activity velocity trend.</CardDescription>
          </CardHeader>
          <CardContent className="h-[240px]">
             <ResponsiveContainer width="100%" height="100%">
               <PieChart>
                 <Pie data={engagementTrendMix} dataKey="count" nameKey="trend" outerRadius={80} fill="#8884d8" label>
                   <Cell fill="#10b981" />
                   <Cell fill="#64748b" />
                   <Cell fill="#ef4444" />
                 </Pie>
        ...
        <Card className="lg:col-span-2">
          <CardHeader>
            <CardTitle className="text-lg flex items-center gap-2">
              <Zap className="h-5 w-5 text-amber-500" /> Skill Gaps & Friction Points
            </CardTitle>
            <CardDescription>Most frequent topics where students are requested mentor intervention.</CardDescription>
          </CardHeader>
          <CardContent className="h-[240px]">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={skillGapBars} layout="vertical">
                <XAxis type="number" hide />
                <YAxis dataKey="gap" type="category" width={140} fontSize={11} tickLine={false} axisLine={false} />
                <Tooltip cursor={{ fill: "transparent" }} />
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-lg">Progress vs Engagement Matrix</CardTitle>
          <CardDescription>Mapping students by how much they&apos;ve completed vs their recent activity level.</CardDescription>
        </CardHeader>
        <CardContent className="h-[400px]">
          <ResponsiveContainer width="100%" height="100%">
            <ScatterChart>
              <XAxis type="number" dataKey="progress" name="Progress" unit="%" fontSize={12} tickLine={false} axisLine={false} />
              <YAxis type="number" dataKey="engagement" name="Engagement" fontSize={12} tickLine={false} axisLine={false} />
...
export default function InstitutionOverviewClient() {
  const { user } = useAuth();
